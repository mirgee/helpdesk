<?php //netteCache[01]000364a:2:{s:4:"time";s:21:"0.56616300 1374675474";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:42:"C:\wamp\www\helpdesk\libs\Grido\Grid.latte";i:2;i:1373612670;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"dc83a21 released on 2013-07-11";}}}?><?php

// source file: C:\wamp\www\helpdesk\libs\Grido\Grid.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'rr6fsj4c0o')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block _grid
//
if (!function_exists($_l->blocks['_grid'][] = '_lb16077418fb__grid')) { function _lb16077418fb__grid($_l, $_args) { extract($_args); $_control->validateControl('grid')
...
// block outerFilter
//
if (!function_exists($_l->blocks['outerFilter'][] = '_lb1a6a982cea_outerFilter')) { function _lb1a6a982cea_outerFilter($_l, $_args) { extract($_args)
...
// block table
//
if (!function_exists($_l->blocks['table'][] = '_lb4b5e6c8b0c_table')) { function _lb4b5e6c8b0c_table($_l, $_args) { extract($_args)
...
<?php if (is_string($column->customRender)): Nette\Latte\Macros\CoreMacros::includeTemplate($column->customRender, array('control' => $control, 'presenter' => $control->presenter, 'item' => $row) + $template->getParameters(), $_l->templates['rr6fsj4c0o'])->render() ;else: ?>
...
// block operations
//
if (!function_exists($_l->blocks['operations'][] = '_lba56a76ef18_operations')) { function _lba56a76ef18_operations($_l, $_args) { extract($_args)
...
// block paginator
//
if (!function_exists($_l->blocks['paginator'][] = '_lb115da9b623_paginator')) { function _lb115da9b623_paginator($_l, $_args) { extract($_args)
...
// block count
//
if (!function_exists($_l->blocks['count'][] = '_lbfba687201c_count')) { function _lbfba687201c_count($_l, $_args) { extract($_args)
?>                <span class="count">
